...
public class WarpManager {
  ...
  public static void load() {
    if (Files.exists(WARPS_FILE)) {
      try {
        ...
        Map<String, Warp> loaded =
            GSON.fromJson(json, new TypeToken<Map<String, Warp>>() {}.getType());
        if (loaded != null) {
          warps.putAll(loaded);
  ...
  public static void createWarp(
      String name, String world, double x, double y, double z, UUID createdBy) {
