...
public class BackupManager {
  ...
  private static final java.util.concurrent.atomic.AtomicInteger totalFiles =
      new java.util.concurrent.atomic.AtomicInteger(0);
  private static final java.util.concurrent.atomic.AtomicInteger processedFiles =
      new java.util.concurrent.atomic.AtomicInteger(0);
  ...
  public static String createBackup() {
    ...
    try {
      ...
      AdminWebDashPlugin.getCustomLogger()
          .info("WARN: Performing Live Backup. World data is not paused/flushed.");
    ...
    try {
      ...
      if (backups.size() > MAX_BACKUPS) {
        ...
        for (int i = 0; i < toDelete; i++) {
          ...
          AdminWebDashPlugin.getCustomLogger()
              .info("Retention Policy: Deleting old backup " + p.getFileName());
            ...
            public java.nio.file.FileVisitResult visitFile(
              ...
              try {
                ...
                try (InputStream is = Files.newInputStream(file)) {
                  ...
                  System.err.println(
                      "Failed to zip file (skipping): " + file + " - " + e.getMessage());
                } finally {
                  zos.closeEntry();
        ...
        () -> {
          try {
            ...
            if (defaultWorld != null) {
              AdminWebDashPlugin.getCustomLogger()
                  .info("Restoring: Reloading world " + defaultWorld);
          ...
          HytaleServer.SCHEDULED_EXECUTOR.scheduleWithFixedDelay(
              () -> {
                try {
                  ...
                  AdminWebDashPlugin.getCustomLogger()
                      .info("Scheduled backup completed: " + fileName);
                } catch (Exception e) {
              ...
              TimeUnit.MINUTES);
      AdminWebDashPlugin.getCustomLogger()
          .info("Scheduled backups every " + interval + " minutes.");
    } else {
